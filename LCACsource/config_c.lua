...
-- LCAC 8 config
--Rememeber to configure your config_c.lua, if it give errors , lags or problems is your fault!!
Config = {}
LXC = {}
Config.Version=8 -- DO NOT TOUCH!
LXC.Eula="pufuleti"
LXC.WebHook = "" -- Discord log webhook url
...
LXC.ViolationDetectedMSG = "LCAC KICKED YOU\nCHEATER KID HAHA :O"
LXC.AdminMenuKey = 178 -- INSERT

----Godmode----
LXC.AGod = true -- DO NOT USE ON VRP
...
LXC.ASpeedHack = true -- On foot (not falling) anti speed hack (optional)
...
LXC.AutomaticDeleteTimeout = 5000 -- This timeout is how often the server checks for blacklisted stuff! (1000 = 1s) (Lower = lag)
